...
setUserEmail(email.target.value)
  ...
  return (
    <div className="">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100 mx-auto mt-[50px]">
        ...
        >
          <div className="space-y-1 text-sm">
            ...
            onBlur={handleEmail}
              ...
              id="email"
              placeholder="Email"
              className="w-full px-4 py-3 rounded-md border-gray- text-black
